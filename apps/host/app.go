...
import (
	...
	resource "github.com/Murphychih/cmdb/apps/resource"
	page "github.com/Murphychih/cmdb/common/pb/page"
	pb_request "github.com/Murphychih/cmdb/common/pb/request"
	"github.com/Murphychih/cmdb/utils"
...
func NewQueryHostRequestFromHTTP(r *http.Request) *QueryHostRequest {
	qs := r.URL.Query()
	page := page.NewPageRequestFromHTTP(r)
	kw := qs.Get("keywords")
